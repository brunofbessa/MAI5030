...
def main():
    ...
    start = timer()
    fitness_sga = calcular_lista_geracoes_ga(sga_trap.main)
    end = timer()
    tempo_sga = end - start

    start = timer()
    fitness_cga = calcular_lista_geracoes_ga(cga_trap.main)
    end = timer()
    tempo_cga = end - start
    ...
    start = timer()
    fitness_sga = calcular_lista_populacoes_ga(sga_trap.main)
    end = timer()
    tempo_sga = end - start
    start = timer()
    fitness_cga = calcular_lista_populacoes_ga(cga_trap.main)
    end = timer()
    tempo_cga = end - start
